...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.949 seconds (33x, 1.947><2.173)

sudoku.go : algo with strings
  - go    : 16.666 seconds (187x, 15.152><17.145)

sudoku.java : algo with strings
  - java  : 27.121 seconds (34x, 21.194><29.266)

sudoku.js : algo with strings
  - node  : 30.434 seconds (44x, 27.547><31.622)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.692 seconds (44x, 22.046><23.646)

sudoku.nim : algo with strings
  - nim   : 23.201 seconds (35x, 22.735><24.379)

sudoku.php : algo with strings
  - php   : 82.975 seconds (3x, 82.408><84.969)

sudoku.py : algo with strings
  - codon : 13.831 seconds (44x, 12.617><14.882)
  - py3   : 88.338 seconds (187x, 86.097><93.138)
  - pypy  : 18.985 seconds (419x, 17.905><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 6.247 seconds (39x, 6.034><6.383)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (32x, 0.129><0.141)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (37x, 2.221><2.375)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.091 seconds (35x, 1.039><1.106)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.816 seconds (35x, 0.808><0.866)
  - py3   : 16.222 seconds (35x, 14.720><16.718)
  - pypy  : 1.094 seconds (35x, 1.070><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.683 seconds (39x, 0.676><0.713)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.374 seconds (30x, 0.366><0.426)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.224 seconds (30x, 0.219><0.245)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.044 seconds (31x, 1.029><1.109)
  - py3   : 11.972 seconds (31x, 11.164><13.681)
  - pypy  : 2.787 seconds (31x, 2.762><3.517)

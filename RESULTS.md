...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.963 seconds (192x, 1.377><2.502)

sudoku.go : algo with strings
  - go    : 16.659 seconds (417x, 9.018><18.214)

sudoku.java : algo with strings
  - java  : 27.080 seconds (13x, 20.744><29.638)

sudoku.js : algo with strings
  - node  : 28.063 seconds (25x, 21.133><29.938)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.512 seconds (229x, 12.584><24.433)

sudoku.nim : algo with strings
  - nim   : 23.292 seconds (265x, 12.758><24.938)

sudoku.php : algo with strings
  - php   : 82.457 seconds (41x, 51.646><91.413)

sudoku.py : algo with strings
  - codon : 30.757 seconds (1x, 30.757><30.757)
  - py3   : 87.972 seconds (417x, 45.878><99.134)
  - pypy  : 18.793 seconds (649x, 10.538><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.408 seconds (13x, 3.552><4.586)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (192x, 0.105><0.155)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.237 seconds (267x, 1.490><2.582)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (265x, 0.694><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.819 seconds (1x, 0.819><0.819)
  - py3   : 16.553 seconds (265x, 8.973><17.875)
  - pypy  : 1.108 seconds (265x, 0.572><1.384)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.715 seconds (13x, 0.623><0.802)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (260x, 0.256><0.455)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (260x, 0.175><0.280)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 0.902 seconds (1x, 0.902><0.902)
  - py3   : 11.972 seconds (261x, 6.591><14.543)
  - pypy  : 2.806 seconds (261x, 1.720><3.517)

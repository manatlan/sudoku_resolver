...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.951 seconds (49x, 1.947><2.191)

sudoku.go : algo with strings
  - go    : 16.665 seconds (203x, 15.152><17.145)

sudoku.java : algo with strings
  - java  : 27.375 seconds (4x, 26.966><29.783)

sudoku.js : algo with strings
  - node  : 30.424 seconds (11x, 29.841><32.321)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.714 seconds (60x, 21.943><23.646)

sudoku.nim : algo with strings
  - nim   : 23.232 seconds (51x, 22.693><24.379)

sudoku.php : algo with strings
  - php   : 82.825 seconds (6x, 81.976><84.281)

sudoku.py : algo with strings
  - codon : 13.831 seconds (60x, 12.549><14.882)
  - py3   : 88.293 seconds (203x, 85.897><93.138)
  - pypy  : 18.972 seconds (435x, 17.905><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 8.389 seconds (4x, 8.374><8.397)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (48x, 0.129><0.141)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (53x, 2.221><2.375)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.090 seconds (51x, 1.039><1.140)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.817 seconds (51x, 0.805><0.866)
  - py3   : 16.309 seconds (51x, 14.647><17.648)
  - pypy  : 1.094 seconds (51x, 1.060><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.685 seconds (4x, 0.679><0.690)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.373 seconds (46x, 0.365><0.426)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.224 seconds (46x, 0.219><0.245)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.043 seconds (47x, 1.024><1.109)
  - py3   : 11.978 seconds (47x, 11.164><13.681)
  - pypy  : 2.784 seconds (47x, 2.762><3.517)

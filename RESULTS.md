...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.956 seconds (44x, 1.949><2.172)

sudoku.go : algo with strings
  - go    : 16.666 seconds (269x, 14.170><17.145)

sudoku.java : algo with strings
  - java  : 27.130 seconds (70x, 20.867><30.332)

sudoku.js : algo with strings
  - node  : 30.146 seconds (8x, 29.950><30.910)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.679 seconds (120x, 21.943><24.433)

sudoku.nim : algo with strings
  - nim   : 23.242 seconds (117x, 22.693><24.381)

sudoku.php : algo with strings
  - php   : 82.430 seconds (72x, 69.539><85.411)

sudoku.py : algo with strings
  - codon : 13.578 seconds (38x, 12.504><13.817)
  - py3   : 88.136 seconds (269x, 85.878><93.138)
  - pypy  : 18.914 seconds (501x, 17.578><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.309 seconds (8x, 4.293><4.334)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (44x, 0.129><0.147)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (119x, 2.167><2.427)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.093 seconds (117x, 1.038><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.822 seconds (38x, 0.809><0.881)
  - py3   : 16.560 seconds (117x, 14.539><17.648)
  - pypy  : 1.096 seconds (117x, 1.044><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.697 seconds (8x, 0.689><0.702)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.376 seconds (112x, 0.365><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (112x, 0.219><0.255)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.041 seconds (38x, 1.014><1.085)
  - py3   : 11.978 seconds (113x, 10.999><13.681)
  - pypy  : 2.788 seconds (113x, 2.760><3.517)

...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.955 seconds (40x, 1.949><2.172)

sudoku.go : algo with strings
  - go    : 16.666 seconds (265x, 14.170><17.145)

sudoku.java : algo with strings
  - java  : 27.118 seconds (66x, 20.867><30.332)

sudoku.js : algo with strings
  - node  : 30.512 seconds (4x, 30.049><30.910)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.679 seconds (116x, 21.943><24.433)

sudoku.nim : algo with strings
  - nim   : 23.242 seconds (113x, 22.693><24.381)

sudoku.php : algo with strings
  - php   : 82.456 seconds (68x, 69.539><85.411)

sudoku.py : algo with strings
  - codon : 13.578 seconds (34x, 12.504><13.817)
  - py3   : 88.136 seconds (265x, 85.878><93.138)
  - pypy  : 18.917 seconds (497x, 17.578><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.328 seconds (4x, 4.306><4.334)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (40x, 0.129><0.147)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (115x, 2.167><2.427)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.093 seconds (113x, 1.038><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.822 seconds (34x, 0.809><0.881)
  - py3   : 16.556 seconds (113x, 14.539><17.648)
  - pypy  : 1.097 seconds (113x, 1.044><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.697 seconds (4x, 0.689><0.698)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.376 seconds (108x, 0.365><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (108x, 0.219><0.255)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.041 seconds (34x, 1.014><1.085)
  - py3   : 11.973 seconds (109x, 10.999><13.681)
  - pypy  : 2.788 seconds (109x, 2.760><3.517)

...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.963 seconds (191x, 1.377><2.502)

sudoku.go : algo with strings
  - go    : 16.659 seconds (416x, 9.018><18.214)

sudoku.java : algo with strings
  - java  : 26.985 seconds (12x, 20.744><29.638)

sudoku.js : algo with strings
  - node  : 28.046 seconds (24x, 21.133><29.938)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.499 seconds (228x, 12.584><24.433)

sudoku.nim : algo with strings
  - nim   : 23.291 seconds (264x, 12.758><24.938)

sudoku.php : algo with strings
  - php   : 82.450 seconds (40x, 51.646><91.413)

sudoku.py : algo with strings
  - codon : 13.615 seconds (185x, 7.802><14.964)
  - py3   : 87.974 seconds (416x, 45.878><99.134)
  - pypy  : 18.794 seconds (648x, 10.538><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.419 seconds (12x, 3.552><4.586)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (191x, 0.105><0.155)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.237 seconds (266x, 1.490><2.582)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (264x, 0.694><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.821 seconds (185x, 0.500><0.916)
  - py3   : 16.553 seconds (264x, 8.973><17.875)
  - pypy  : 1.108 seconds (264x, 0.572><1.384)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.714 seconds (12x, 0.623><0.802)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (259x, 0.256><0.455)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (259x, 0.175><0.280)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.043 seconds (185x, 0.690><1.150)
  - py3   : 11.972 seconds (260x, 6.591><14.543)
  - pypy  : 2.806 seconds (260x, 1.720><3.517)

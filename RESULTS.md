...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.964 seconds (199x, 1.377><2.502)

sudoku.go : algo with strings
  - go    : 16.658 seconds (424x, 9.018><18.214)

sudoku.java : algo with strings
  - java  : 27.032 seconds (20x, 19.211><29.638)

sudoku.js : algo with strings
  - node  : 28.046 seconds (32x, 20.819><29.938)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.485 seconds (234x, 12.584><24.433)

sudoku.nim : algo with strings
  - nim   : 23.295 seconds (272x, 12.758><26.146)

sudoku.php : algo with strings
  - php   : 82.450 seconds (48x, 51.646><91.413)

sudoku.py : algo with strings
  - codon : 31.458 seconds (1x, 31.458><31.458)
  - py3   : 87.963 seconds (424x, 45.878><99.134)
  - pypy  : 18.777 seconds (656x, 10.538><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.406 seconds (7x, 3.562><4.580)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (199x, 0.105><0.155)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.237 seconds (274x, 1.490><2.582)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (272x, 0.694><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.828 seconds (1x, 0.828><0.828)
  - py3   : 16.553 seconds (272x, 8.973><17.875)
  - pypy  : 1.109 seconds (272x, 0.572><1.384)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.723 seconds (7x, 0.640><0.814)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (267x, 0.256><0.455)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (267x, 0.175><0.280)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 0.897 seconds (1x, 0.897><0.897)
  - py3   : 11.972 seconds (268x, 6.591><14.543)
  - pypy  : 2.806 seconds (268x, 1.720><3.517)

...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.951 seconds (23x, 1.947><2.173)

sudoku.go : algo with strings
  - go    : 16.666 seconds (177x, 15.152><17.145)

sudoku.java : algo with strings
  - java  : 27.074 seconds (24x, 21.194><28.987)

sudoku.js : algo with strings
  - node  : 30.324 seconds (34x, 27.547><31.622)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.646 seconds (34x, 22.046><23.538)

sudoku.nim : algo with strings
  - nim   : 23.182 seconds (25x, 22.735><24.379)

sudoku.php : algo with strings
  - php   : 82.014 seconds (34x, 69.074><83.059)

sudoku.py : algo with strings
  - codon : 13.824 seconds (34x, 12.617><14.882)
  - py3   : 88.402 seconds (177x, 86.097><93.138)
  - pypy  : 18.999 seconds (409x, 17.905><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 6.247 seconds (29x, 6.034><6.287)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (22x, 0.129><0.141)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (27x, 2.221><2.375)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.091 seconds (25x, 1.039><1.096)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.815 seconds (25x, 0.808><0.866)
  - py3   : 16.217 seconds (25x, 14.720><16.632)
  - pypy  : 1.094 seconds (25x, 1.070><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.683 seconds (29x, 0.677><0.713)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.373 seconds (20x, 0.366><0.426)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.224 seconds (20x, 0.219><0.245)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.048 seconds (21x, 1.029><1.109)
  - py3   : 11.963 seconds (21x, 11.164><13.681)
  - pypy  : 2.781 seconds (21x, 2.762><3.517)

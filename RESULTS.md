...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.951 seconds (40x, 1.947><2.191)

sudoku.go : algo with strings
  - go    : 16.666 seconds (194x, 15.152><17.145)

sudoku.java : algo with strings
  - java  : 27.120 seconds (41x, 21.194><29.601)

sudoku.js : algo with strings
  - node  : 29.939 seconds (2x, 29.841><30.038)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.683 seconds (51x, 21.943><23.646)

sudoku.nim : algo with strings
  - nim   : 23.223 seconds (42x, 22.693><24.379)

sudoku.php : algo with strings
  - php   : 82.243 seconds (2x, 81.641><82.846)

sudoku.py : algo with strings
  - codon : 13.829 seconds (51x, 12.549><14.882)
  - py3   : 88.302 seconds (194x, 85.897><93.138)
  - pypy  : 18.978 seconds (426x, 17.905><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 6.244 seconds (46x, 6.030><6.383)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (39x, 0.129><0.141)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (44x, 2.221><2.375)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.091 seconds (42x, 1.039><1.106)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.817 seconds (42x, 0.808><0.866)
  - py3   : 16.222 seconds (42x, 14.647><17.106)
  - pypy  : 1.093 seconds (42x, 1.060><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.683 seconds (46x, 0.676><0.713)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.375 seconds (37x, 0.366><0.426)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (37x, 0.219><0.245)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.043 seconds (38x, 1.025><1.109)
  - py3   : 11.972 seconds (38x, 11.164><13.681)
  - pypy  : 2.788 seconds (38x, 2.762><3.517)

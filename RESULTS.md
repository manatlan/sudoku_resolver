...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.954 seconds (38x, 1.949><2.172)

sudoku.go : algo with strings
  - go    : 16.666 seconds (263x, 14.170><17.145)

sudoku.java : algo with strings
  - java  : 27.122 seconds (64x, 20.867><30.332)

sudoku.js : algo with strings
  - node  : 30.480 seconds (2x, 30.049><30.910)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.679 seconds (114x, 21.943><24.433)

sudoku.nim : algo with strings
  - nim   : 23.242 seconds (111x, 22.693><24.381)

sudoku.php : algo with strings
  - php   : 82.430 seconds (66x, 69.539><85.411)

sudoku.py : algo with strings
  - codon : 13.586 seconds (32x, 12.504><13.817)
  - py3   : 88.159 seconds (263x, 85.878><93.138)
  - pypy  : 18.920 seconds (495x, 17.578><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.328 seconds (2x, 4.323><4.334)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (38x, 0.129><0.147)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.234 seconds (113x, 2.167><2.427)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.092 seconds (111x, 1.038><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.823 seconds (32x, 0.809><0.881)
  - py3   : 16.556 seconds (111x, 14.539><17.648)
  - pypy  : 1.097 seconds (111x, 1.044><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.697 seconds (2x, 0.697><0.697)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.376 seconds (106x, 0.365><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (106x, 0.219><0.255)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.042 seconds (32x, 1.014><1.085)
  - py3   : 11.972 seconds (107x, 10.999><13.681)
  - pypy  : 2.788 seconds (107x, 2.760><3.517)

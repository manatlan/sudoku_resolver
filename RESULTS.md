...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.958 seconds (10x, 1.947><2.173)

sudoku.go : algo with strings
  - go    : 16.668 seconds (164x, 15.152><17.145)

sudoku.java : algo with strings
  - java  : 26.992 seconds (11x, 21.194><28.987)

sudoku.js : algo with strings
  - node  : 30.294 seconds (21x, 27.547><31.214)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.644 seconds (21x, 22.046><23.538)

sudoku.nim : algo with strings
  - nim   : 23.097 seconds (12x, 22.735><23.823)

sudoku.php : algo with strings
  - php   : 82.118 seconds (21x, 69.074><82.950)

sudoku.py : algo with strings
  - codon : 13.808 seconds (21x, 12.617><14.882)
  - py3   : 88.461 seconds (164x, 86.241><93.138)
  - pypy  : 19.013 seconds (396x, 17.905><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 6.241 seconds (16x, 6.034><6.287)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (9x, 0.129><0.141)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (14x, 2.222><2.375)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.090 seconds (12x, 1.039><1.095)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.816 seconds (12x, 0.808><0.866)
  - py3   : 16.178 seconds (12x, 14.720><16.419)
  - pypy  : 1.093 seconds (12x, 1.079><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.686 seconds (16x, 0.677><0.713)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.375 seconds (7x, 0.366><0.426)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (7x, 0.219><0.245)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.047 seconds (8x, 1.031><1.109)
  - py3   : 11.995 seconds (8x, 11.164><12.342)
  - pypy  : 2.783 seconds (8x, 2.763><3.517)

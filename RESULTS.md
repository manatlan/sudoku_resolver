...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.953 seconds (32x, 1.949><2.172)

sudoku.go : algo with strings
  - go    : 16.666 seconds (257x, 14.170><17.145)

sudoku.java : algo with strings
  - java  : 27.104 seconds (58x, 20.867><30.332)

sudoku.js : algo with strings
  - node  : 30.212 seconds (15x, 27.531><31.769)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.707 seconds (108x, 21.943><24.433)

sudoku.nim : algo with strings
  - nim   : 23.251 seconds (105x, 22.693><24.381)

sudoku.php : algo with strings
  - php   : 82.377 seconds (60x, 69.539><85.411)

sudoku.py : algo with strings
  - codon : 13.586 seconds (26x, 12.504><13.817)
  - py3   : 88.165 seconds (257x, 85.878><93.138)
  - pypy  : 18.931 seconds (489x, 17.578><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.310 seconds (15x, 4.299><4.450)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (32x, 0.129><0.147)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.234 seconds (107x, 2.179><2.427)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.092 seconds (105x, 1.038><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.823 seconds (26x, 0.809><0.881)
  - py3   : 16.560 seconds (105x, 14.539><17.648)
  - pypy  : 1.098 seconds (105x, 1.044><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.697 seconds (15x, 0.690><0.744)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.376 seconds (100x, 0.365><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (100x, 0.219><0.255)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.041 seconds (26x, 1.014><1.085)
  - py3   : 11.953 seconds (101x, 10.999><13.681)
  - pypy  : 2.788 seconds (101x, 2.760><3.517)

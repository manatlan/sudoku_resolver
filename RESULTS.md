...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.964 seconds (200x, 1.338><2.502)

sudoku.go : algo with strings
  - go    : 16.658 seconds (425x, 8.686><18.214)

sudoku.java : algo with strings
  - java  : 26.987 seconds (21x, 14.409><29.638)

sudoku.js : algo with strings
  - node  : 28.028 seconds (33x, 15.766><29.938)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.483 seconds (235x, 12.199><24.433)

sudoku.nim : algo with strings
  - nim   : 23.292 seconds (273x, 12.327><26.146)

sudoku.php : algo with strings
  - php   : 82.444 seconds (49x, 41.264><91.413)

sudoku.py : algo with strings
  - codon : 24.972 seconds (2x, 18.485><31.458)
  - py3   : 87.961 seconds (425x, 44.890><99.134)
  - pypy  : 18.777 seconds (657x, 10.044><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.403 seconds (8x, 2.909><4.580)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (200x, 0.105><0.155)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.237 seconds (275x, 1.490><2.582)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (273x, 0.686><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.660 seconds (2x, 0.491><0.828)
  - py3   : 16.552 seconds (273x, 8.973><17.875)
  - pypy  : 1.109 seconds (273x, 0.572><1.384)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.714 seconds (8x, 0.456><0.814)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (268x, 0.253><0.455)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (268x, 0.175><0.280)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 0.733 seconds (2x, 0.569><0.897)
  - py3   : 11.971 seconds (269x, 6.400><14.543)
  - pypy  : 2.806 seconds (269x, 1.596><3.517)

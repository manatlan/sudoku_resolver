...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.952 seconds (68x, 1.947><2.191)

sudoku.go : algo with strings
  - go    : 16.664 seconds (222x, 14.170><17.145)

sudoku.java : algo with strings
  - java  : 27.084 seconds (23x, 20.867><29.783)

sudoku.js : algo with strings
  - node  : 30.222 seconds (30x, 27.289><32.321)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.714 seconds (76x, 21.943><24.433)

sudoku.nim : algo with strings
  - nim   : 23.237 seconds (70x, 22.693><24.379)

sudoku.php : algo with strings
  - php   : 82.379 seconds (25x, 69.539><85.411)

sudoku.py : algo with strings
  - codon : 13.520 seconds (14x, 12.449><13.650)
  - py3   : 88.219 seconds (222x, 85.878><93.138)
  - pypy  : 18.961 seconds (454x, 17.714><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 8.397 seconds (23x, 7.363><8.671)
...
specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (72x, 2.221><2.423)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.090 seconds (70x, 1.038><1.144)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.816 seconds (14x, 0.806><0.869)
  - py3   : 16.459 seconds (70x, 14.539><17.648)
  - pypy  : 1.097 seconds (70x, 1.060><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.688 seconds (23x, 0.679><0.746)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.374 seconds (65x, 0.365><0.431)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.225 seconds (65x, 0.219><0.255)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.040 seconds (14x, 1.022><1.071)
  - py3   : 11.976 seconds (66x, 10.999><13.681)
  - pypy  : 2.787 seconds (66x, 2.760><3.517)

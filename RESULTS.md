...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.957 seconds (63x, 1.949><2.172)

sudoku.go : algo with strings
  - go    : 16.664 seconds (288x, 14.080><17.145)

sudoku.java : algo with strings
  - java  : 27.167 seconds (89x, 20.867><30.332)

sudoku.js : algo with strings
  - node  : 30.051 seconds (27x, 27.456><33.246)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.648 seconds (135x, 21.943><24.433)

sudoku.nim : algo with strings
  - nim   : 23.255 seconds (136x, 22.693><24.381)

sudoku.php : algo with strings
  - php   : 83.067 seconds (1x, 83.067><83.067)

sudoku.py : algo with strings
  - codon : 13.584 seconds (57x, 12.504><14.098)
  - py3   : 88.110 seconds (288x, 85.878><93.138)
  - pypy  : 18.896 seconds (520x, 17.578><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.335 seconds (7x, 4.311><4.502)
...
specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.234 seconds (138x, 2.167><2.427)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.093 seconds (136x, 1.038><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.821 seconds (57x, 0.805><0.881)
  - py3   : 16.583 seconds (136x, 14.539><17.648)
  - pypy  : 1.095 seconds (136x, 1.044><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.704 seconds (7x, 0.688><0.734)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.377 seconds (131x, 0.365><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.226 seconds (131x, 0.219><0.255)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.041 seconds (57x, 1.014><1.085)
  - py3   : 11.984 seconds (132x, 10.999><13.681)
  - pypy  : 2.796 seconds (132x, 2.760><3.517)

...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.960 seconds (125x, 1.377><2.174)

sudoku.go : algo with strings
  - go    : 16.661 seconds (350x, 9.018><17.145)

sudoku.java : algo with strings
  - java  : 27.056 seconds (48x, 13.164><29.328)

sudoku.js : algo with strings
  - node  : 27.344 seconds (1x, 27.344><27.344)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.581 seconds (173x, 12.584><24.433)

sudoku.nim : algo with strings
  - nim   : 23.321 seconds (198x, 12.758><24.795)

sudoku.php : algo with strings
  - php   : 82.015 seconds (15x, 41.795><90.743)

sudoku.py : algo with strings
  - codon : 13.609 seconds (119x, 7.802><14.098)
  - py3   : 88.091 seconds (350x, 45.878><99.134)
  - pypy  : 18.836 seconds (582x, 10.538><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.295 seconds (21x, 2.871><4.495)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (125x, 0.105><0.148)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.236 seconds (200x, 1.490><2.433)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (198x, 0.694><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.820 seconds (119x, 0.500><0.881)
  - py3   : 16.569 seconds (198x, 8.973><17.875)
  - pypy  : 1.099 seconds (198x, 0.572><1.250)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.681 seconds (21x, 0.429><0.766)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (193x, 0.256><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (193x, 0.175><0.274)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.043 seconds (119x, 0.690><1.085)
  - py3   : 11.955 seconds (194x, 6.591><13.681)
  - pypy  : 2.804 seconds (194x, 1.720><3.517)

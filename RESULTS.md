...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.951 seconds (15x, 1.947><2.173)

sudoku.go : algo with strings
  - go    : 16.667 seconds (169x, 15.152><17.145)

sudoku.java : algo with strings
  - java  : 27.015 seconds (16x, 21.194><28.987)

sudoku.js : algo with strings
  - node  : 30.301 seconds (26x, 27.547><31.214)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.642 seconds (26x, 22.046><23.538)

sudoku.nim : algo with strings
  - nim   : 23.165 seconds (17x, 22.735><23.823)

sudoku.php : algo with strings
  - php   : 82.184 seconds (26x, 69.074><82.950)

sudoku.py : algo with strings
  - codon : 13.819 seconds (26x, 12.617><14.882)
  - py3   : 88.438 seconds (169x, 86.097><93.138)
  - pypy  : 19.002 seconds (401x, 17.905><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 6.247 seconds (21x, 6.034><6.287)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.129 seconds (14x, 0.129><0.141)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.233 seconds (19x, 2.222><2.375)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.089 seconds (17x, 1.039><1.096)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.816 seconds (17x, 0.808><0.866)
  - py3   : 16.221 seconds (17x, 14.720><16.632)
  - pypy  : 1.092 seconds (17x, 1.070><1.167)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.686 seconds (21x, 0.677><0.713)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.375 seconds (12x, 0.366><0.426)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.224 seconds (12x, 0.219><0.245)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.044 seconds (13x, 1.031><1.109)
  - py3   : 11.963 seconds (13x, 11.164><13.681)
  - pypy  : 2.778 seconds (13x, 2.763><3.517)

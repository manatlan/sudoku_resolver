...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.961 seconds (131x, 1.377><2.174)

sudoku.go : algo with strings
  - go    : 16.661 seconds (356x, 9.018><17.145)

sudoku.java : algo with strings
  - java  : 27.056 seconds (54x, 13.164><29.328)

sudoku.js : algo with strings
  - node  : 28.574 seconds (7x, 26.356><30.103)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.615 seconds (178x, 12.584><24.433)

sudoku.nim : algo with strings
  - nim   : 23.321 seconds (204x, 12.758><24.795)

sudoku.php : algo with strings
  - php   : 79.161 seconds (5x, 68.603><83.048)

sudoku.py : algo with strings
  - codon : 13.605 seconds (125x, 7.802><14.098)
  - py3   : 88.052 seconds (356x, 45.878><99.134)
  - pypy  : 18.836 seconds (588x, 10.538><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.449 seconds (1x, 4.449><4.449)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (131x, 0.105><0.148)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.236 seconds (206x, 1.490><2.433)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (204x, 0.694><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.820 seconds (125x, 0.500><0.887)
  - py3   : 16.567 seconds (204x, 8.973><17.875)
  - pypy  : 1.099 seconds (204x, 0.572><1.260)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.748 seconds (1x, 0.748><0.748)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (199x, 0.256><0.436)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (199x, 0.175><0.274)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.043 seconds (125x, 0.690><1.085)
  - py3   : 11.955 seconds (200x, 6.591><13.681)
  - pypy  : 2.804 seconds (200x, 1.720><3.517)

...
sudoku.c : algo with strings (made by gemini3 from py version)
  - c     : 1.964 seconds (116x, 1.616><2.174)

sudoku.go : algo with strings
  - go    : 16.659 seconds (341x, 10.970><17.145)

sudoku.java : algo with strings
  - java  : 27.029 seconds (39x, 19.218><29.129)

sudoku.js : algo with strings
  - node  : 27.764 seconds (31x, 21.039><29.676)

sudoku.mojo : algo with strings (use python to read stdin)
  - mojo  : 22.581 seconds (165x, 16.156><24.433)

sudoku.nim : algo with strings
  - nim   : 23.307 seconds (189x, 18.631><24.795)

sudoku.php : algo with strings
  - php   : 80.554 seconds (6x, 79.238><82.825)

sudoku.py : algo with strings
  - codon : 13.604 seconds (110x, 10.701><14.098)
  - py3   : 88.093 seconds (341x, 67.401><99.134)
  - pypy  : 18.842 seconds (573x, 13.837><36.082)

sudoku.rs : algo with Strings (as byte[])
  - rust  : 4.313 seconds (12x, 3.446><4.485)
...
specialized/sudoku.c : algo OPTIMIZED (by copilot)
  - c     : 0.130 seconds (116x, 0.114><0.148)

specialized/sudoku.go : algo with arrays (optimized by copilot)
  - go    : 2.236 seconds (191x, 1.867><2.433)

specialized/sudoku.nim : algo with specialized types using bitsets (optimized by copilot)
  - nim   : 1.094 seconds (189x, 0.884><1.287)

specialized/sudoku.py : algo with specialized types/logics (optimized by copilot)
  - codon : 0.820 seconds (110x, 0.633><0.881)
  - py3   : 16.569 seconds (189x, 12.858><17.875)
  - pypy  : 1.098 seconds (189x, 0.831><1.250)

specialized/sudoku.rs : algo with specialized types
  - rust  : 0.679 seconds (12x, 0.597><0.766)

specialized/sudoku2.go : from c to go (by gemini3)
  - go    : 0.378 seconds (184x, 0.294><0.435)

specialized/sudoku2.nim : from c to nim (by gemini3)
  - nim   : 0.227 seconds (184x, 0.193><0.274)

specialized/sudoku2.py : conversion from C to py3 (by gemini3)
  - codon : 1.043 seconds (110x, 0.830><1.085)
  - py3   : 11.958 seconds (185x, 8.829><13.681)
  - pypy  : 2.804 seconds (185x, 2.287><3.517)
